...
| Voice: hearing you | `POST {base}/audio/transcriptions` | Multipart `file` (16 kHz mono WAV), `model`, `response_format=json`. Must return `{"text": "…"}`. The language is auto-detected. |
