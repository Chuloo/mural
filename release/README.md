...
- [x] Implement Norwegian, Spanish, English, French, German, Italian, Brazilian Portuguese, Mandarin and Afrikaans modules, language/subtitle onboarding, versioned AI consent, local backups and the existing conversation controls.
...
| Final device checks | Test the candidate on an iPhone: microphone denial, offline/failing API requests, interruptions, cellular use, reset, meanings, export/import and deletion. Review pronunciation and corrections for all nine languages with proficient speakers, including Mandarin pinyin and tones. Automated live checks do not establish teaching quality. |
